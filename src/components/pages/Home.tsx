import { Box, Checkbox, CheckboxGroup, Divider, Flex, Heading, Stack, Wrap, WrapItem} from "@chakra-ui/react";
        ...
        <Wrap p={{base:4,md:10}} justify="center">
            <WrapItem>
                <Stack textAlign="center">
                    <MainButton  loading={loading} onClick={onClickGoUserSearch}>就活仲間を検索</MainButton>
                </Stack>
                <Stack textAlign="center">
                    <MainButton  loading={loading} onClick={onClickGoCoDeveloper}>共同開発者
                    を探す</MainButton>
                </Stack>
                <Stack textAlign="center">
                    <MainButton  loading={loading} onClick={onClickGoFriendList}>友だちリスト</MainButton>
                </Stack>
            </WrapItem>
            </Wrap>
        <Heading as="h1" p={6} size="xl" textAlign="center">マイページ</Heading>
